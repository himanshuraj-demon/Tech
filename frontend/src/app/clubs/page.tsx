...
export default function ClubsPage() {
  ...
  const technicalCouncilGroups = clubs.filter(
    (item) => item.type === "technical-council-group",
  );
        ...
        <div className="container relative z-10 mobile-padding">
          <div className="flex flex-col items-center space-y-4 sm:space-y-6 text-center">
            ...
            <p className="mx-auto max-w-[700px] responsive-text-base text-muted-foreground leading-relaxed px-4 sm:px-0">
              Discover your passion and join a community of like-minded
              innovators across technical clubs and hobby groups
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mobile-padding">
          <div className="responsive-grid-1-3 gap-6 sm:gap-8 text-center">
            <div className="space-y-2 sm:space-y-3 mobile-card bg-white/50 dark:bg-gray-800/50 rounded-lg">
              ...
              <div className="responsive-text-lg font-semibold">
                Technical Clubs
              </div>
          ...
          <div className="container mobile-padding">
            <div className="text-center section-margin">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Join our technical clubs to enhance your skills, work on
                cutting-edge projects, and collaborate with fellow tech
                enthusiasts
              </p>
            </div>
        ...
        <section className="section-padding bg-muted/20">
          <div className="container mobile-padding">
            <div className="text-center section-margin">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Specialized groups operating under the Technical Council,
                providing unique resources and opportunities for innovation and
                development
              </p>
            </div>
            <div className="responsive-grid-1-2-3 gap-4 sm:gap-6">
        ...
        <section className="section-padding bg-muted/30">
          <div className="container mobile-padding">
            <div className="text-center section-margin">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Explore your creative side and pursue your hobbies with
                like-minded individuals in our diverse hobby groups
              </p>
            </div>
            <div className="responsive-grid-1-2-3 gap-4 sm:gap-6">
