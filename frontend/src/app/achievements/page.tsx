...
export default function AchievementsPage() {
  ...
  const stats = {
    ...
    competitions: new Set(
      interIITAchievements.map((a: UIAchievement) => a.event),
    ).size,
    participants: new Set(
      interIITAchievements.flatMap((a: UIAchievement) => a.team.split(", ")),
    ).size,
    yearsActive: new Set(interIITAchievements.map((a: UIAchievement) => a.year))
      .size,
  };
        ...
        <div className="container relative z-10 px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            ...
            <p className="mx-auto max-w-[700px] text-lg text-muted-foreground md:text-xl">
              Celebrating excellence in technology, innovation, and competitive
              spirit
            </p>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div className="text-center space-y-4">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground">
                Our stellar performance in the most prestigious technical
                competition among IITs
              </p>
            </div>

            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {interIITAchievements.length > 0 ? (
                interIITAchievements.map(
                  (achievement: UIAchievement, index: number) => (
                    <div
                      key={index}
                      className="glass rounded-xl p-6 transition-all duration-300 hover:scale-105 hover:shadow-xl">
